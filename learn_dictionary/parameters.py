...
class Parameters():
    def __init__(self):
        ...
        self.path_for_eval =os.path.join(project_path,"output_example","train_50_test_1000_output_example")

        self.run_name="train20_test_100_threshold5_Atoms200_Anchor2_Alpha2_Iters2000_Epoch1000_Mode1234_lr0.01"
