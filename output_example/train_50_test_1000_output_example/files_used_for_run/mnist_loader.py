...
def load_mnist():
    X, y = loadlocal_mnist(
        images_path=r"C:\data\git\Dict\Dictionary_Learning\data\t10k-images.idx3-ubyte",
        labels_path=r"C:\data\git\Dict\Dictionary_Learning\data\t10k-labels.idx1-ubyte")
