...
def load_and_eval(model_path,saved_data_file, eval_mode):
    ...
    return tot_samples,success_rate

tot_samples_test,success_rate_test=load_and_eval(model_path,saved_data_file, eval_mode="test")
tot_samples_train,success_rate_train=load_and_eval(model_path,saved_data_file, eval_mode="train")
print("************************")
